...
- **Try it Out** - Click **[here](https://gearshiftstudios.github.io/mystic-engine/src/engine/examples/terrain/renderer.html)** to open it in a **full window**. _Ctrl + Click_ to open it in separate tab. Or you can just try it out below all this text.
...
- **Controls** - Hold down _Left Mouse Button_ to **rotate** around scene. Hold down _Right Mouse Button_ to **pan** around scene.
